...
class MainTabBarViewController: UITabBarController {
    ...
    fileprivate func configureTabBar() {
        ...
        setViewControllers([homeNavigationController, comingSoonNavigationController, topSearchersNavigationController, downloadsNavigationController], animated: true)
    }
